...
public class TutorialCrawler extends DeepCrawler {
	...
	public TutorialCrawler(String crawlPath) {
		...
		regexRule.addRule("http://.*meishij.net/.*");
		...
		try {
			jdbcTemplate = JDBCHelper
					.createMysqlTemplate(
							"mysql1",
							"jdbc:mysql://localhost:3306/crawler?useUnicode=true&characterEncoding=utf8",
							"root", "409569210", 5, 30);
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		TutorialCrawler crawler = new TutorialCrawler("F:\\cache");
